//instalamos una dependencia para encriptar las contraseñas --> yarn add bcryptjs
//y para usarlo con typescript instalamos --> yarn add @types/bcryptjs
    ...
    users: [
        {
            ...
            password: bcrypt.hashSync('123456'), //encriptamos la contraseña con la importacion de arriba
            role: 'admin'
        },
        {
            name: 'Manuel Lopez',
